...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//И.Кропивко Добавление кода по модулю 13_7
	//НачалоДоработки
	...
	ПолеКонтактноеЛицо.ПутьКДанным = "Объект.neto_КонтактноеЛицо";
	//КонецДоработки
	
	//И.Кропивко Добавление кода по модулю 13_7
	//НачалоДоработки
	ПолеСогласованнаяСкидка = Элементы.Добавить("СогласованнаяСкидка", Тип("ПолеФормы"), Элементы.ГруппаШапкаЛево);
	ПолеСогласованнаяСкидка.Вид = ВидПоляФормы.ПолеВвода;
	ПолеСогласованнаяСкидка.ПутьКДанным = "Объект.neto_СогласованнаяСкидка";
...
//И.Кропивко Добавление кода по модулю 11_2, задание 2
&НаКлиенте
